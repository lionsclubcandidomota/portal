...
import { clearSecureStorageSession, setActiveSecureStorageSession } from '../assets/js/modules/secure-storage/session-store.js?v=6.45.0';
...
test('migração 0005 ativa modelos de leitura e eleva o esquema D1', async () => {
  ...
  assert.equal(D1_SCHEMA_VERSION, 7);
