...
import {
  ...
  normalizePortalFont,
  settingsFrom
} from './settings-appearance.js?v=6.52.3';
import { directorProfileFromState, hasLegacyDirectorTokenProfile } from './portal-runtime/access-profile.js?v=6.52.3';
import { registerMembershipFeeChange } from './membership-fees.js?v=6.52.3';
