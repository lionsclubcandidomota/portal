import { createPortalEnvelope, migratePortalPayload } from '../../core/portal-schema.js?v=6.44.0';
import { RUNTIME_STORAGE_KEYS } from './constants.js?v=6.44.0';
import { normalizePendingChanges } from './domain.js?v=6.44.0';
