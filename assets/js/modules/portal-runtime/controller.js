...
} from '../../github-public.js?v=6.49.1';

let githubAdminPromise = null;

function loadGitHubAdmin() {
  if (!githubAdminPromise) {
    githubAdminPromise = import('../../github-admin.js?v=6.49.1').catch(error => {
...
import { createPortalRuntimeContext } from './context.js?v=6.49.1';
import { createPersistenceActions } from './persistence.js?v=6.49.1';
import { createAdminSessionActions } from './session.js?v=6.49.1';
import { createPublicationActions } from './publication.js?v=6.49.1';
import { createRemoteSyncActions } from './remote-sync.js?v=6.49.1';
import { createBootstrapAction } from './bootstrap.js?v=6.49.1';
import { createInterfaceRefreshActions } from './interface-refresh.js?v=6.49.1';
import { createAccessProfileActions } from './access-profile.js?v=6.49.1';
import {
  ACCESS_CAPABILITIES,
  accessSnapshot,
  canAccessView,
  roleHasCapability
} from './authorization.js?v=6.49.1';
