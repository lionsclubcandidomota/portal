...
} from '../../github.js?v=6.46.0';
import { createPortalRuntimeContext } from './context.js?v=6.46.0';
import {
...
} from '../../core/portal-data-boundary.js?v=6.46.0';
import { createPersistenceActions } from './persistence.js?v=6.46.0';
import { createPrivateSyncActions } from './private-sync.js?v=6.46.0';
import { createAdminSessionActions } from './session.js?v=6.46.0';
import { createPublicationActions } from './publication.js?v=6.46.0';
import { createRemoteSyncActions } from './remote-sync.js?v=6.46.0';
import { createBootstrapAction } from './bootstrap.js?v=6.46.0';
import { createInterfaceRefreshActions } from './interface-refresh.js?v=6.46.0';
import { createLiveSyncActions } from './live-sync.js?v=6.46.0';
import { createAccessProfileActions } from './access-profile.js?v=6.46.0';
import {
  ACCESS_CAPABILITIES,
  accessSnapshot,
  canAccessView,
