...
import { createAuditLogController } from './audit-log.js?v=6.38.0';
import { createRecoveryCenterController } from './recovery-center.js?v=6.38.0';
...
import {
  ...
  locationInfo,
  renderLocation
} from './appointments.js?v=6.38.0';
import { createPortalRuntimeController } from './portal-runtime.js?v=6.38.0';
import { getPortalElements } from './portal-elements.js?v=6.38.0';
import { createPortalViewRenderer } from './portal-view-renderer.js?v=6.38.0';
import { createTreasuryFeature } from './portal-composition/treasury-feature.js?v=6.38.0';
import { createAdministrationFeature } from './portal-composition/administration-feature.js?v=6.38.0';
import { createPublicationFeature } from './portal-composition/publication-feature.js?v=6.38.0';
import { createNavigationFeature } from './portal-composition/navigation-feature.js?v=6.38.0';
import { createPortalViewRendererOptions } from './portal-composition/view-dependencies.js?v=6.38.0';
import { createDatabaseSyncIndicator } from './database-sync-indicator.js?v=6.38.0';
