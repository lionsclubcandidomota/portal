...
import { createEntityFormsController } from '../entity-forms.js?v=6.36.1';
import { createAdminPanelController } from '../admin-panel.js?v=6.36.1';
import { createReportsController } from '../reports/controller.js?v=6.36.1';
