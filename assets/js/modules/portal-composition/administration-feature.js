...
import { createEntityFormsController } from '../entity-forms.js?v=6.35.1';
import { createAdminPanelController } from '../admin-panel.js?v=6.35.1';
import { createReportsController } from '../reports/controller.js?v=6.35.1';
