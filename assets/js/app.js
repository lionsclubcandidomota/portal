import { bootstrapPortal } from './modules/portal-app.js?v=6.46.7';
import { enableHomologationReload } from './core/homologation-reload.js?v=6.46.7';
import { uiIcon } from './modules/visual-helpers.js?v=6.46.7';
